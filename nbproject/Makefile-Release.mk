...
# Test Files
TESTFILES= \
	${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/projeto_poo
...
${OBJECTDIR}/arqtexto.o: arqtexto.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/arqtexto.o arqtexto.cpp

${OBJECTDIR}/Persistencia.o: Persistencia.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Persistencia.o Persistencia.cpp

${OBJECTDIR}/ErroSave.o: ErroSave.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ErroSave.o ErroSave.cpp

${OBJECTDIR}/Tabuleiro.o: Tabuleiro.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Tabuleiro.o Tabuleiro.cpp

${OBJECTDIR}/Peca.o: Peca.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Peca.o Peca.cpp
...
${OBJECTDIR}/arqtexto_nomain.o: ${OBJECTDIR}/arqtexto.o arqtexto.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/arqtexto_nomain.o arqtexto.cpp;\
	else  \
...
${OBJECTDIR}/Persistencia_nomain.o: ${OBJECTDIR}/Persistencia.o Persistencia.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/Persistencia_nomain.o Persistencia.cpp;\
	else  \
...
${OBJECTDIR}/ErroSave_nomain.o: ${OBJECTDIR}/ErroSave.o ErroSave.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/ErroSave_nomain.o ErroSave.cpp;\
	else  \
...
${OBJECTDIR}/Tabuleiro_nomain.o: ${OBJECTDIR}/Tabuleiro.o Tabuleiro.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/Tabuleiro_nomain.o Tabuleiro.cpp;\
	else  \
...
${OBJECTDIR}/Peca_nomain.o: ${OBJECTDIR}/Peca.o Peca.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/Peca_nomain.o Peca.cpp;\
	else  \
...
${OBJECTDIR}/Casa_nomain.o: ${OBJECTDIR}/Casa.o Casa.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/Casa_nomain.o Casa.cpp;\
	else  \
...
${OBJECTDIR}/jogo_nomain.o: ${OBJECTDIR}/jogo.o jogo.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/jogo_nomain.o jogo.cpp;\
	else  \
...
.test-conf:
	@if [ "${TEST}" = "" ]; \
	then  \
	    ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/projeto_poo || true; \
	else  \
	    ./${TEST} || true; \
	fi
